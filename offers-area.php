               ...
               <div class="row">
                   <div class="col-xl-12">
                       <div class="section_title text-center mb-100">
                           ...
                           <span>Tekliflerimiz</span>
                           <h3>Devam eden indirimler</h3>
                       </div>
                   </div>
               </div>
               <div class="row">
                   <?php
                    ...
                    $product_query = $dbconn->prepare("SELECT * FROM product WHERE product_is_active = '1' and product_is_highlight = '1' ");
