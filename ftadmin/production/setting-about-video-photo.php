            ...
            <form action="../netting/process.php" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="setting_about_video_photo_url_old" value="<?php echo $setting_about_data['setting_about_video_photo_url']; ?>" class="form-control col-md-7 col-xs-12" readonly>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  if (strlen($setting_about_data['setting_about_video_photo_url']) > 0) { ?>
                    <img width="300" src="../../<?php echo $setting_about_data['setting_about_video_photo_url']; ?>">
                  <?php } else { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="first-name" name="setting_about_video_photo_url" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div class="form-group">
                <div class="col-md-3 col-sm-3 col-xs-12"></div>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <label class="blinking-text col-md-12 col-sm-12 col-xs-12" for="first-name">!!! Not: 1920x740 önerilir !!! </label>
                </div>
              </div>
              ...
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="setting_about_video_photo_edit" class="btn btn-success">Güncelle</button>
              </div>
            </form>
          </div>
        </div>
