            ...
            <form action="../netting/process.php" method="POST" enctype="multipart/form-data" data-parsley-validate class="form-horizontal form-label-left">
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="first-name" name="setting_about_photo2_url_old" value="<?php echo $setting_about_data['setting_about_photo2_url']; ?>" class="form-control col-md-7 col-xs-12" readonly>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  ...
                  if (strlen($setting_about_data['setting_about_photo2_url']) > 0) { ?>
                    <img width="300" src="../../<?php echo $setting_about_data['setting_about_photo2_url']; ?>">
                  <?php } else { ?>
              ...
              <div class="form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="file" id="first-name" name="setting_about_photo2_url" class="form-control col-md-7 col-xs-12">
                </div>
              </div>
              ...
              <div align="right" class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                <button type="submit" name="setting_about_photo2_edit" class="btn btn-success">Güncelle</button>
              </div>
            </form>
          </div>
        </div>
